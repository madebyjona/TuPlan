...
abstract class WPOrg_Meta_Box
{
    ...
    {
        $screens = ['inmueble', 'wporg_cpt'];
        foreach ($screens as $screen) {
            add_meta_box(
                'tp_meta_boxes',          // Unique ID
                'Datos inmueble', // Box title
    ...
    public static function save(int $post_id)
    {
        ...
        if (array_key_exists('tp_features', $_POST)){
            update_post_meta(
                $post_id, 
                '_tp_features', 
                $_POST["tp_features"]
        ...
        if (array_key_exists('tp_warranty', $_POST)){
            update_post_meta(
                $post_id, 
                '_tp_warranty', 
                $_POST["tp_warranty"]
...
?>
        ...
        <div class="tp_meta_field tp-features">
            ...
            <div class="fields">
                <label><input type="checkbox" name="tp_features[]" value="Semiamoblado" <?php if (in_array('Semiamoblado', $tp_features)) echo 'checked'; ?> /> Semiamoblado </label>
                <label><input type="checkbox" name="tp_features[]" value="Amoblado" <?php if (in_array('Amoblado', $tp_features)) echo 'checked'; ?> /> Amoblado </label>
                <label><input type="checkbox" name="tp_features[]" value="Entrepiso" <?php if (in_array('Entrepiso', $tp_features)) echo 'checked'; ?> /> Entrepiso </label>
                <label><input type="checkbox" name="tp_features[]" value="Cocina" <?php if (in_array('Cocina', $tp_features)) echo 'checked'; ?> /> Cocina </label>
                <label><input type="checkbox" name="tp_features[]" value="Kitchenette" <?php if (in_array('Kitchenette', $tp_features)) echo 'checked'; ?> /> Kitchenette </label>
                <label><input type="checkbox" name="tp_features[]" value="Despensa" <?php if (in_array('Despensa', $tp_features)) echo 'checked'; ?> /> Despensa</label>
                <label><input type="checkbox" name="tp_features[]" value="Galpón" <?php if (in_array('Galpón', $tp_features)) echo 'checked'; ?> /> Galpón</label>
                <label><input type="checkbox" name="tp_features[]" value="Garage" <?php if (in_array('Garage', $tp_features)) echo 'checked'; ?> /> Garage</label>
                <label><input type="checkbox" name="tp_features[]" value="Balcón" <?php if (in_array('Balcón', $tp_features)) echo 'checked'; ?> /> Balcón</label>
                <label><input type="checkbox" name="tp_features[]" value="Patio" <?php if (in_array('Patio', $tp_features)) echo 'checked'; ?> /> Patio</label>
                <label><input type="checkbox" name="tp_features[]" value="Jardín" <?php if (in_array('Jardín', $tp_features)) echo 'checked'; ?> /> Jardín</label>
                <label><input type="checkbox" name="tp_features[]" value="Parrillero" <?php if (in_array('Parrillero', $tp_features)) echo 'checked'; ?> /> Parrillero</label>
                <label><input type="checkbox" name="tp_features[]" value="Terraza" <?php if (in_array('Terraza', $tp_features)) echo 'checked'; ?> /> Terraza</label>
                <label><input type="checkbox" name="tp_features[]" value="Wifi" <?php if (in_array('Wifi', $tp_features)) echo 'checked'; ?> /> Wifi</label>
                <label><input type="checkbox" name="tp_features[]" value="Calefacción" <?php if (in_array('Calefacción', $tp_features)) echo 'checked'; ?> /> Calefacción</label>
                <label><input type="checkbox" name="tp_features[]" value="Estufa a leña" <?php if (in_array('Estufa a leña', $tp_features)) echo 'checked'; ?> />Estufa a leña</label>
                <label><input type="checkbox" name="tp_features[]" value="Reja perimetral" <?php if (in_array('Reja perimetral', $tp_features)) echo 'checked'; ?> /> Reja perimetral</label>
                <label><input type="checkbox" name="tp_features[]" value="Seguridad" <?php if (in_array('Seguridad', $tp_features)) echo 'checked'; ?> /> Seguridad</label>
                <label><input type="checkbox" name="tp_features[]" value="Alarma" <?php if (in_array('Alarma', $tp_features)) echo 'checked'; ?> /> Alarma</label>
                <label><input type="checkbox" name="tp_features[]" value="Hall" <?php if (in_array('Hall', $tp_features)) echo 'checked'; ?> /> Hall</label>
                <label><input type="checkbox" name="tp_features[]" value="Lavadero" <?php if (in_array('Lavadero', $tp_features)) echo 'checked'; ?> /> Lavadero</label>
                <label><input type="checkbox" name="tp_features[]" value="Ascensor" <?php if (in_array('Ascensor', $tp_features)) echo 'checked'; ?> /> Ascensor</label>
                <label><input type="checkbox" name="tp_features[]" value="Portería" <?php if (in_array('Portería', $tp_features)) echo 'checked'; ?> /> Portería</label>
                <label><input type="checkbox" name="tp_features[]" value="Barrio privado" <?php if (in_array('Barrio privado', $tp_features)) echo 'checked'; ?> /> Barrio privado</label>
                <label><input type="checkbox" name="tp_features[]" value="Vivienda Social" <?php if (in_array('Vivienda Social', $tp_features)) echo 'checked'; ?> /> Vivienda Social</label>
                <label><input type="checkbox" name="tp_features[]" value="Acepta mascotas" <?php if (in_array('Acepta mascotas', $tp_features)) echo 'checked'; ?> /> Acepta mascotas</label>
            </div>
        </div>
        ...
        <div class="tp_meta_field tp-features">
            ...
            <div class="fields">
                <label><input type="checkbox" name="tp_warranty[]" value="Sin garantía" <?php if (in_array('Sin garantía', $tp_warranty)) echo 'checked'; ?> /> Sin garantía</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Porto Seguro" <?php if (in_array('Porto Seguro', $tp_warranty)) echo 'checked'; ?> /> Porto Seguro</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Sancor Seguro" <?php if (in_array('Sancor Seguro', $tp_warranty)) echo 'checked'; ?> /> Sancor Seguro</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Anda" <?php if (in_array('Anda', $tp_warranty)) echo 'checked'; ?> /> Anda</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Sura" <?php if (in_array('Sura', $tp_warranty)) echo 'checked'; ?> /> Sura</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Mapfre" <?php if (in_array('Mapfre', $tp_warranty)) echo 'checked'; ?> /> Mapfre</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Contaduría" <?php if (in_array('Contaduría', $tp_warranty)) echo 'checked'; ?> /> Contaduría</label>
                <label><input type="checkbox" name="tp_warranty[]" value="BHU" <?php if (in_array('BHU', $tp_warranty)) echo 'checked'; ?> /> BHU</label>
                <label><input type="checkbox" name="tp_warranty[]" value="BBVA" <?php if (in_array('BBVA', $tp_warranty)) echo 'checked'; ?> /> BBVA</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Santander" <?php if (in_array('Santander', $tp_warranty)) echo 'checked'; ?> /> Santander</label>
                <label><input type="checkbox" name="tp_warranty[]" value="Otra" <?php if (in_array('Otra', $tp_warranty)) echo 'checked'; ?> /> Otra</label>
            </div>
        </div>
